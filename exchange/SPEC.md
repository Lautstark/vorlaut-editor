...
- The talker's `.obz` export is a different profile of OBF with a different
  ...
  See [`adr/0001-two-ext-namespaces.md`](https://github.com/Lautstark/vorlaut-diy-talker/blob/main/adr/0001-two-ext-namespaces.md).
...
deliberately not unified; see [`adr/0001`](https://github.com/Lautstark/vorlaut-diy-talker/blob/main/adr/0001-two-ext-namespaces.md).
