...
export const TEXTS = {
  "de": {
    ...
    "ui.credits_arasaac": "Piktogramme: ARASAAC, Urheber Sergio Palao, Lizenz CC BY-NC-SA.",
    "ui.credits_both": "Symbole: METACOM 9 (Annette Kitzinger), lizenziert für diesen Rechner - sie werden nur verwiesen, nicht ins Projekt kopiert. Piktogramme: ARASAAC, Urheber Sergio Palao, Lizenz CC BY-NC-SA.",
  ...
  "en": {
    ...
    "ui.credits_arasaac": "Pictograms: ARASAAC, author Sergio Palao, licence CC BY-NC-SA.",
    "ui.credits_both": "Symbols: METACOM 9 (Annette Kitzinger), licensed for this computer - they are only referenced, not copied into the project. Pictograms: ARASAAC, author Sergio Palao, licence CC BY-NC-SA.",
